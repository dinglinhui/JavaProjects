...
public class ClassScanner {
	 ...
	 */
	public Integer scanning(String basePath, String packagePath)
			throws ClassNotFoundException {
		packPrefix = basePath;
	...
	public Integer scanning(String packagePath, boolean recursive) {
		...
		try {
			...
			dir = Thread.currentThread().getContextClassLoader()
					.getResources(filePackPath);
			packPrefix = Thread.currentThread().getContextClassLoader()
					.getResource("").getPath();
	 ...
	 * @throws ClassNotFoundException
	 */
	private void scanJ(URL url, boolean recursive) throws IOException,
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		int c = cs.scanning("W:/IWiFI/Code/trunk/operation/target/classes/",
				"com/cnp/andromeda/common/util/");
