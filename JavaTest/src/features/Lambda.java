...
public class Lambda {
	...
	public static void main(String[] args) {
		...
		// In Java 8:
		Arrays.asList("Lambdas", "Default Method", "Stream API",
				"Date and Time API").forEach(n -> System.out.println(n));

		System.out.println(Arrays.asList(1, 2, 3).stream().mapToInt((x) -> x)
